...
class PictureOptionDialog(context: Context,val listener:OnClickListener):
    BaseBottomDialog(context,style = R.style.CommonDialogBottomStyle,isCancelable = true){
